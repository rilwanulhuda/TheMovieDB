...
class MoviesProvider {
    ...
    func getNowPlaying(page: Int, completion: @escaping (FetchResutlt<MoviesResponseModel, String>) -> Void) {
    ...
    func getTopRatedMovies(page: Int, completion: @escaping (FetchResutlt<MoviesResponseModel, String>) -> Void) {
        let model = MoviesRequestModel(page: page)
        let endpoint = Endpoint.topRated(model: model)
        networkService.request(endpoint: endpoint, completion: completion)
    }

    func getPopularMovies(page: Int, completion: @escaping (FetchResutlt<MoviesResponseModel, String>) -> Void) {
        let model = MoviesRequestModel(page: page)
